...
def dev():
    ...
    env.remote = 'origin'
    env.branch = 'master'
    env.hosts = ['dev.voulnteerivr.com']
    env.dotenv_path = '/home/ubuntu/dev/voulnteerivr/.env'
...
def qa():
    ...
    env.remote = 'origin'
    env.branch = 'qa'
    env.hosts = ['qa.voulnteerivr.com']
    env.dotenv_path = '/home/ubuntu/qa/voulnteerivr/.env'
    env.config_setter = fab.run
...
def prod():
    ...
    env.remote = 'origin'
    env.branch = 'prod'
    env.hosts = ['prod.voulnteerivr.com']
    env.dotenv_path = '/home/ubuntu/prod/voulnteerivr/.env'
    env.config_setter = fab.run
