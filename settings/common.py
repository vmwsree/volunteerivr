"""Django settings for Volunteer  IVR Management project.
...
APPS_DIR = ROOT_DIR.path('voulnteerivr')
...
# ------------------------------------------------------------------------------
REST_FRAMEWORK = {
    'DEFAULT_PAGINATION_CLASS': 'voulnteerivr.base.api.pagination.PageNumberPagination',
    'PAGE_SIZE': 30,
    ...
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'voulnteerivr.users.auth.backends.UserTokenAuthentication',

        # Mainly used for api debug.
        'rest_framework.authentication.SessionAuthentication',
    ),
    'EXCEPTION_HANDLER': 'voulnteerivr.base.exceptions.exception_handler',
}
...
SITE_NAME = env("SITE_NAME", default='Volunteer  IVR Management')
...
FRONTEND_SITE_NAME = env('FRONTEND_SITE_NAME', default='Volunteer  IVR Management')
...
# URL CONFIGURATION
# ------------------------------------------------------------------------------
ROOT_URLCONF = 'voulnteerivr.urls'
...
DEFAULT_FROM_EMAIL = env('DEFAULT_FROM_EMAIL',
                         default='Volunteer  IVR Management <support@voulnteerivr.com>')
EMAIL_SUBJECT_PREFIX = env('EMAIL_SUBJECT_PREFIX', default='[Volunteer  IVR Management] ')
...
DATABASES = {
    'default': env.db('DATABASE_URL', default='postgres://localhost/voulnteerivr'),
}
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'context_processors': [
                'voulnteerivr.base.context_processors.site_settings',
...
CSRF_FAILURE_VIEW = 'voulnteerivr.base.views.csrf_failure'
...
def get_release():
    ...
    import os
    import raven
    release = voulnteerivr.__version__
    try:
